...
filename = '../WEB-DATA/MODELS/POLITICO.sav'
joblib.dump(clas, filename)
filename = '../WEB-DATA/VECTORS/POLITICO.sav'
...
filename = '../WEB-DATA/MODELS/CONDUTTORE.sav'
joblib.dump(clas, filename)
filename = '../WEB-DATA/VECTORS/CONDUTTORE.sav'
joblib.dump(vect, filename)
